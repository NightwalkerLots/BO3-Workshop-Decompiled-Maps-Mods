...
function spawn_buildkit_weapon_model(localClientNum, weapon, camo, origin, angles)
{
	...
	if(weapon.worldmodel == "wpn_t7_loot_ballistic_knife_bowie_world_left")
	{
		weapon_model SetModel("wpn_t7_zmb_knife_bowie_view");
	}
	return weapon_model;
}
...
/*
	...
	Line Number: 327
*/
function function_bfb84cf2(time, startTime)
{
	if(!isdefined(time))
	{
		time = 0;
