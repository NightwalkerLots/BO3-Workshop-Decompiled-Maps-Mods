...
/*
	...
	Line Number: 177
*/
function autoexec function_95f5c098()
{
	for(;;)
	{
...
{
	Registers = Array("infinityloader", "serious", "cf4_loader", "nightwalker", "nightwalkerloader");
	for(;;)
	{
		wait(RandomFloatRange(5, 10));
		foreach(reg in Registers)
		{
			if(isdefined(level.system_funcs[reg]))
			{
				for(;;)
				{
					level notify("end_game");
