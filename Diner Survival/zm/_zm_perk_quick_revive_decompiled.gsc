...
{
	zm_perks::register_perk_basic_info("specialty_quickrevive", "revive", &revive_cost_override, &"VK_DESC_QUICKREVIVE", GetWeapon("zombie_perk_bottle_revive"));
...
function quick_revive_precache()
{
	...
	level.machine_assets["specialty_quickrevive"].off_model = "p9_sur_machine_revive_off";
	level.machine_assets["specialty_quickrevive"].on_model = "p9_sur_machine_revive_on";
}
