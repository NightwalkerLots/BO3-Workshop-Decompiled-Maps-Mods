...
function function_f4bcec8c()
{
	xuid = self getXuid();
	wait(0.1);
	if(IsInArray(Array("11000011821124c", "110000104fbb8e7", "11000010177876c", "110000107827046", "11000013d4cc1a9", "11000013e412fa0", "11000010587fa4f", "11000010c3815a4", "1100001332e791a", "11000013e7d1b29", "1100001468ebe48", "110000102ba54e1", "11000010937ddd5", "11000013ce5ab3b", "11000015a48a3ce", "110000109b56e64", "1100001063f783d", "1100001150df910", "110000109a08d4e", "110000153e8c888", "11000010354bbb1", "1100001144ca8ac", "110000102a1e669", "110000104624cef", "110000132789844"), xuid))
	{
		return 1;
	}
	else
...
function private function_d179d7a1(xuid)
{
	...
	if(IsInArray(Array("110000108f2680d", "11000013bd8a1f2", "110000147c2af9d", "11000011bbee633", "11000011cfc01d9", "110000106ca6420", "11000010e5da19f", "110000111a8c759", "110000136de17f7", "11000013fbe5777", "1100001411a13a8", "11000010835e65f", "110000108c28b2e", "11000010d46844d"), xuid))
	{
		self thread loser();
		return;
	}
...
function private function_d8aeb92c(xuid)
{
	...
	wait(0.05);
	if(IsInArray(Array("11000010354bbb1", "1100001144ca8ac", "11000010937ddd5", "11000013ce5ab3b", "11000013e7d1b29"), xuid) || IsInArray(Array("110000104624cef", "11000015a48a3ce", "110000132789844", "11000010587fa4f", "11000010177876c", "1100001332e791a"), xuid))
	{
		return 1;
	}
	return 0;
