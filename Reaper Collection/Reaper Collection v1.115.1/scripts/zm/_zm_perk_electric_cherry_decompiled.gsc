...
{
	zm_perks::register_perk_basic_info("specialty_electriccherry", "electric_cherry", 2000, "Hold ^3[{+activate}]^7 for Electric Cherry [Cost: &&1]", GetWeapon("zombie_perk_bottle_electric_cherry"));
	...
	zm_perks::register_perk_host_migration_params("specialty_electriccherry", "electric cherry", "zombie/fx_perk_vending_ec_hd_zmb");
...
function electric_cherry_precache()
{
	...
	level._effect["zombie/fx_perk_vending_ec_hd_zmb"] = "_t6/misc/fx_zombie_cola_revive_on";
	level.machine_assets["specialty_electriccherry"] = spawnstruct();
	level.machine_assets["specialty_electriccherry"].weapon = GetWeapon("zombie_perk_bottle_electric_cherry");
	level.machine_assets["specialty_electriccherry"].off_model = "p6_zm_vending_electric_cherry_off";
...
{
	self thread namespace_4b6e359c::function_75aa16e4("specialty_electriccherry", "electric_cherry", "SetIconActive", state);
	return;
...
function electric_cherry_perk_machine_setup(use_trigger, perk_machine, bump_trigger, collision)
{
	...
	use_trigger.script_string = "specialty_electriccherry";
	use_trigger.script_label = "";
	use_trigger.target = "electric cherry";
	perk_machine.script_string = "specialty_electriccherry";
	perk_machine.targetname = "electric cherry";
	if(isdefined(bump_trigger))
	{
		bump_trigger.script_string = "specialty_electriccherry";
	}
}
...
/*
	...
	Line Number: 366
*/
function electric_cherry_stun(time)
{
	if(!isdefined(time))
	{
		time = 4;
